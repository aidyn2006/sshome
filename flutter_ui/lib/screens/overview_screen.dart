...
class _OverviewScreenState extends State<OverviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final overviewIndex = dockItems.indexWhere((item) => item.id == 'overview');
    ...
    return Scaffold(
      ...
      bottomNavigationBar: DockTabs(
        items: dockItems,
        selectedIndex: overviewIndex < 0 ? 0 : overviewIndex,
        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => Navigator.pushReplacementNamed(context, '/overview'),
                child: const Text('Обзор', style: TextStyle(color: Colors.lightBlueAccent)),
              ),
            ],
          ),
