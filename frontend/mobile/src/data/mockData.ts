...
export const devices: Device[] = [
  ...
  { id: "d2", name: "Front Door", type: "DOOR", status: "CLOSED", room_id: "r1" },
  { id: "d3", name: "Air Conditioner", type: "AC", status: "ON", room_id: "r2" },
  { id: "d4", name: "Bedroom Light", type: "LIGHT", status: "OFF", room_id: "r2" },
  { id: "d5", name: "Thermostat", type: "TEMP", status: "OFF", room_id: "r3" },
  { id: "d6", name: "Kitchen Light", type: "LIGHT", status: "OFF", room_id: "r3" }
];

export const events: Event[] = [
  { id: "e1", type: "DEVICE", device_id: "d1", action: "TURN_ON", timestamp: Date.now() - 120000 },
  { id: "e2", type: "DEVICE", device_id: "d2", action: "CLOSE", timestamp: Date.now() - 300000 },
  { id: "e3", type: "DEVICE", device_id: "d3", action: "TURN_ON", timestamp: Date.now() - 3600000 }
];
...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    actions: [
      { device_id: "d4", action: "TURN_ON" },
      { device_id: "d3", action: "TURN_ON" }
    ]
  },
  {
    id: "s3",
    ...
    actions: [{ device_id: "d1", action: "TURN_OFF" }]
  },
  {
    id: "s4",
    name: "Night Mode",
